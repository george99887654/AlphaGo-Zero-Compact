...
def main():
    ...
    parser.add_argument('--lagent', required=True)
...
#     experience_file = os.path.join(args.work_dir, 'zerov5_exp_temp.hdf5')
#     tmp_agent = os.path.join(args.work_dir, 'zerov5_agent_temp.hdf5')
#     working_agent = os.path.join(args.work_dir, 'zerov5_agent_cur.hdf5')
    total_games = 0
    while True:
