...
#     parser.add_argument('--hidden-size', type=int, default=512)
    ...
    for i in range(4):                     # <1>
        pb = Conv2D(64, (3, 3),            # <1>
            ...
            bias_regularizer=l2(0.0001))(pb)         # <1>
    ...
    policy_conv = \
        Conv2D(2, (1, 1),                                   # <2>
            ...
            activation='relu',
            kernel_regularizer=l2(0.0001),
            bias_regularizer=l2(0.0001))(pb)                          # <2>
    policy_flat = Flatten()(policy_conv)                    # <2>
    policy_output = \
        Dense(encoder.num_moves(), 
              activation='softmax', 
              kernel_regularizer=l2(0.0001), 
              bias_regularizer=l2(0.0001))(policy_flat)                                    # <2>
    ...
    value_conv = \
        Conv2D(1, (1, 1),                                    # <3>
            ...
            activation='relu',
            kernel_regularizer=l2(0.0001),
            bias_regularizer=l2(0.0001))(pb)                           # <3>
    value_flat = Flatten()(value_conv)                       # <3>
    value_hidden = Dense(256, activation='relu', kernel_regularizer=l2(0.0001), bias_regularizer=l2(0.0001))(value_flat) # <3>
    value_output = Dense(1, activation='tanh', kernel_regularizer=l2(0.0001), bias_regularizer=l2(0.0001))(value_hidden) # <3>
